...
router.get('/category', isAuthenticated_1.isAuthenticated, new ListCategoryController_1.ListCadegoryController().handle);
//-- Rotas Product --
router.post('/product', isAuthenticated_1.isAuthenticated, upload.single('file'), new CreatProductController_1.CreatProductController().handle);
